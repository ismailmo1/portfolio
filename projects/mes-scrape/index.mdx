---
name: "MES-Scraper"
description: Extracting manufacturing data from MES systems for root cause analysis
...
Having some programming knowledge meant that clicking around the same menus looking for information was more painful than it should be, so I quickly got to work to start automating common tasks.
